...
class ResourceTrackerActivity : AppCompatActivity() {
    ...
    // Corrected dummy data using the new unified Shelter data class
    private val dummyShelters = listOf(
        Shelter(
            ...
            capacity = 100,
            currentOccupancy = 45,
            supplies = listOf("Water", "Blankets", "Canned Food"),
        ...
        Shelter(
            ...
            capacity = 150,
            currentOccupancy = 90,
            supplies = listOf("Medical Kits", "Baby Formula"),
        ...
        Shelter(
            ...
            supplies = listOf("Water", "Cots", "Pet Food"),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Corrected adapter instantiation, passing null for user location
        shelterAdapter = ShelterAdapter(dummyShelters, null)
